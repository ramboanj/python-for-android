...
class DlibRecipe(CppCompiledComponentsPythonRecipe):
    ...
    built_libraries = {"libdlib.so" : "build/libdlib"}
    ...
    def build_arch(self, arch):
        ...
        with current_directory(build_dir):
            ...
            lib_dir = join(build_dir,"libdlib")
            ...
            shprint(sh.cmake,                        
                   # execute CMake in Tools/Python to build
                    ...
                    '-DDCMAKE_ANDROID_ARCH_ABI:STRING={}'.format(arch.arch),                                          
                    '-DCMAKE_ANDROID_STANDALONE_TOOLCHAIN:PATH={}'.format(self.ctx.ndk_dir),                  
                    '-DANDROID_NATIVE_API_LEVEL:STRING={}'.format(self.ctx.ndk_api),                      
                    '-DANDROID_EXECUTABLE:FILEPATH={}/tools/android'.format(env['ANDROID_SDK']),            
                    '-DCMAKE_TOOLCHAIN_FILE:FILEPATH={}'.format(                                            
